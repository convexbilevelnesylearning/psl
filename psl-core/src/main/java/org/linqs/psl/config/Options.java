...
public class Options {
    ...
    public static final Option WLA_GRADIENT_DESCENT_ENERGY_LOSS_COEFFICIENT = new Option(
        "gradientdescent.energylosscoefficient",
        0.0f,
        "Add the energy loss to the objective function with this coefficient."
    );
    ...
    public static final Option WLA_GRADIENT_DESCENT_MAX_INFERENCE_BUDGET = new Option(
        "gradientdescent.iterationinferencebudget",
        1.0f,
        "The proportion of inference iterations to take per learning iteration."
    );
    ...
    public static final Option WLA_GRADIENT_DESCENT_L2_USER_SET_WEIGHT_REGULARIZATION = new Option(
        "gradientdescent.l2usersetregularization",
        0.0f,
        "The L2 regularization parameter of the difference between the learned and user set weight.",
        Option.FLAG_NON_NEGATIVE
    );
    ...
    public static final Option WLA_GRADIENT_DESCENT_MIN_NUM_STEPS = new Option(
        "gradientdescent.minnumsteps",
        10,
        "The minimum number of steps the gradient descent weight learner will take.",
        Option.FLAG_POSITIVE
    );
    ...
    public static final Option WLA_GRADIENT_DESCENT_VALIDATION_BREAK_WINDOW = new Option(
        "gradientdescent.validationbreakwindow",
        100,
        "Break gradient descent when the number of iterations between a validation increase is greater than this value."
    );

    public static final Option WLA_GRADIENT_DESCENT_VALIDATION_BREAK = new Option(
        "gradientdescent.validationbreak",
        false,
        "Break gradient descent when the number of iterations between a validation increase is greater than the value set by gradientdescent.validationbreakwindow."
    );
